                      ...
                      cells: [
                        ...
                        DataCell(
                          Column(
                            children: [
                              Text(recortarTexto(
                                  interpretacionCompuestos[index], 50)),
                            ],
                          ),
                        ),
                      ],
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    width: 500,
                    height: 300,
                    child: CompuestosChart(pruebasuelo.graficaCompuestos,
                        pruebasuelo.valorgraficaCompuestos),
                  ),
                  const SizedBox(height: 16),
                  Container(
                    width: 500,
                    height: 300,
                    child: CompuestosChart(pruebasuelo.graficaCompuestos2,
                        pruebasuelo.valorgraficaCompuestos2),
                  )
                ],
              ),
            ),
              ...
              child: Center(
                ...
                child: Column(
                  children: [
                    ...
                    _buildTextField(
                        'Recomendaciones',
                        'Ingresa el primer texto aquí',
                        _recomendacionesController),
                    const SizedBox(height: 16),
                    _buildTextField('Presiembra',
                        'Ingresa el segundo texto aquí', _presiembraController),
                    const SizedBox(height: 16),
                    _buildTextField('Siembra', 'Ingresa el tercer texto aquí',
                        _siembraController),
                    const SizedBox(height: 16),
                    _buildTextField(
                        'Mantenimiento',
                        'Ingresa el cuarto texto aquí',
